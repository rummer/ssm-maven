    ...
    <div class="easyui-tabs" fit="true" border="false" id="tabs">
        <div title="首页" data-options="iconCls:'icon-home'">
            <div align="center" style="padding-top: 30px;">
                <a href="https://git.oschina.net/zhenfeng13/ssm-demo"
                    target="_blank" style="font-size: 30px;">
                <p>开源中国仓库地址</p>
            </a>
            </div>
            <div align="center">
                <a href="https://github.com/ZHENFENG13/ssm-demo" target="_blank"
                    ...
                    <p>Gitub仓库地址</p></a></div>
            <div align="center" style="padding-top:10px; width:100%;height: 100%" onclick="displayDefault()">
                <div id="default_show" >
                    <font color="grey" size="10">ssm demo for jcet</font>
                </div>

                <div align="center" style="display: none" id="click_show">
                    <div style="padding-bottom: 20px">
                        <a href="${pageContext.request.contextPath}/test.html" target="_blank">
                            <p style="font-family:cursive;font-size: 30px;color:grey;margin-bottom: -20px;">夜風吹亂月光，心有焰藏，何處安放</p>
                        </a>

                    </div>
                    <div style="">
                        <a href="${pageContext.request.contextPath}/test.html" target="_blank">
                            <p style="font-family:cursive;font-size:30px;color:grey;margin-bottom: -20px;">快馬笑醉年華，夢裡折花，淡看天涯</p>
                        </a>
                    </div>
                </div>
            </div>
